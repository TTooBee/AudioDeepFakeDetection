...
def main(args):
    ...
    dataset = AudioFeaturesDataset(args.real, args.fake, feature=args.feature, feature_dim=args.feature_dim, model_type=args.model)
    ...
    if args.model == 'lstm' or args.model == 'cnn':
        ...
        model_args = {
            "filts": [[1, 16], [16, 32], [32, 64]],  # 첫 번째 차원은 입력 채널 수를 맞춤
            "gru_node": 1024,
            "nb_gru_layer": 1,
            "nb_fc_node": 512,
            "nb_classes": 1
