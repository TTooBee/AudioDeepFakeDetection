...
class AudioFeaturesDataset(Dataset):
    def __init__(self, base_folder_real, base_folder_fake, feature, feature_dim, model_type, train=True, test_split=0.2):
        # 저장된 텐서 파일 이름 설정
        ...
        if os.path.exists(tensor_file):
            ...
            if feature == 'evs':
                ...
                features_real = extract_mfcc(base_folder_real, feature_dim)
                features_fake = extract_mfcc(base_folder_fake, feature_dim)
...
if __name__ == "__main__":
    ...
    train_dataset = AudioFeaturesDataset(args.real, args.fake, feature=args.feature, feature_dim=args.feature_dim, model_type=args.model, train=True)
    test_dataset = AudioFeaturesDataset(args.real, args.fake, feature=args.feature, feature_dim=args.feature_dim, model_type=args.model, train=False)
